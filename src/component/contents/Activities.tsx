    ...
    return (
        <div className={`${style.contentCon} ${style.NtnuBg}`}>
            ...
            <div className={style.content}>
                <img className={`${style.picture} ${style.certificate}`} src='/picture/activitiesPics/NTNU/certificateNTNU.png' alt='' />
        ...
        <div className={`${style.contentCon} ${style.Debsirin}`}>
            ...
            <div className={style.content}>
                <div className={style.detail}>
                    ...
                    <div  className={style.link}>Click here to see <span onClick={()=>window.open('https://drive.google.com/drive/folders/1YkOLA4hLfh6p4705YnUXQpAWl5LTOWiJ?usp=sharing')}> Appointment Order</span></div>
                </div>
